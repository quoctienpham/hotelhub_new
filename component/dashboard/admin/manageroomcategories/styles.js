...
export const selectStyles = {
  // Styles for the FormControl wrapper (optional)
  formControl: {
    sx: {
      '& .MuiInputLabel-root': {
  ...
  select: {
    sx: {
      ...
      '& .MuiOutlinedInput-notchedOutline': {
        borderColor: '#8A12FC', // Border color
      },
      ...
      '& .MuiSvgIcon-root': {
        color: '#8A12FC', // Dropdown icon color
      },
    }
  },
  ...
  menuItem: {
    sx: {
      '&.Mui-selected': {
        backgroundColor: 'rgba(138, 18, 252, 0.08)',
      },
      '&.Mui-selected:hover': {
        backgroundColor: 'rgba(138, 18, 252, 0.12)',
      },
    }
  },
